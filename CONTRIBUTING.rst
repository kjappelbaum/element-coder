...
----------------------------------
1. Check that you have the latest version of :code:`element_coder`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/kjappelbaum/element-coder/issues
...
.. code-block:: sh
    ...
    $ git clone https://github.com/<YourUsername>/element-coder
...
If you spend a while working on your changes, further commits may be made to the main :code:`element_coder`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/kjappelbaum/element-coder
